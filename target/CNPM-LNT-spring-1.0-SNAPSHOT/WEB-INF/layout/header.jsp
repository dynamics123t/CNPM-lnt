    ...
    <div class="grid">
        ...
        <div class="header__with--search">
            ...
            <div class="header__cart">
                <a href="<c:url value="/giohang"/>"><i class="header__cart--icon fa-solid fa-cart-shopping"></i></a>              
            </div>
        </div>
    </div>          
</header>
                    ...
                    <div class="auform__container">
                        ...
                        <div class="auform__form">
                            <div class="auform__group">
                                <form:input type="text"  placeholder="User" path="user"/>
                            </div>
                            <div class="auform__group">
                                <form:input type="text" placeholder="Email của bạn" path="email"/>
                            </div>
                            <div class="auform__group">
                                <form:input type="password" placeholder="Mật khẩu của bạn" path="pass"/>
                            </div>
                            <div class="auform__group">
                                <form:input type="password" placeholder="Nhập lại mật khẩu của bạn" path="repass" id="repass"/>
                            </div>
                        </div>
