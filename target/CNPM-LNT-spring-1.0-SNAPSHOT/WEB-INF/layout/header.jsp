                ...
                <nav class="header__navbar">
                    <ul class="header__navbar-list">
                        ...
                        <li class="header__navbar-item">
                            ...
                            <a href="" class="header__navbar-icon-link"><i class="header__navbar-icon fa fa-facebook-f" style="font-size:36px"></i></a>
                            ...
                            <div class="auform__container">
                                ...
                                <div class="auform__form">
                                     <div class="auform__group">
                                        <input type="text" class="auform__input" placeholder="User" name="user">
                                    </div>
                                    <div class="auform__group">
                                        <input type="text" class="auform__input" placeholder="Email của bạn" name="email">
                                    </div>
                                    <div class="auform__group">
                                        <input type="password" class="auform__input" placeholder="Mật khẩu của bạn" name="pass">
                                    </div>
                                    <div class="auform__group">
                                        <input type="password"  class="auform__input" placeholder="Nhập lại mật khẩu của bạn" name="repass" id="repass">
                                    </div>
                                </div>
